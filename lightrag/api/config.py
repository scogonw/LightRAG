...
def parse_args() -> argparse.Namespace:
    ...
    # Deliberately narrower than upstream's "/health,/api/*": that default exempts the
    # Ollama-compat routes from authentication entirely, and /api/chat serves RAG
    # answers across every org. Opt in explicitly if you need those routes public.
