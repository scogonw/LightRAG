    ...
    **Signature** — preserved unchanged from earlier LightRAG releases
    ...
    def __post_init__(self, addon_params: dict[str, Any] | None):
        ...
        self.entities_vdb: BaseVectorStorage = self.vector_db_storage_cls(  # type: ignore
            ...
            workspace=self.workspace,
            embedding_func=self.embedding_func,
            meta_fields={"entity_name", "source_id", "content", "file_path", "metadata", "org_id", "knowledgebase_id", "access_levels"},
        )
        self.relationships_vdb: BaseVectorStorage = self.vector_db_storage_cls(  # type: ignore
            namespace=NameSpace.VECTOR_STORE_RELATIONSHIPS,
            workspace=self.workspace,
            embedding_func=self.embedding_func,
            meta_fields={"src_id", "tgt_id", "source_id", "content", "file_path", "metadata", "org_id", "knowledgebase_id", "access_levels"},
        )
    ...
    async def get_knowledge_graph(
        ...
        Args:
            ...
            org_id (str, optional): Organization ID for multi-tenant filtering.
                When provided, only nodes/edges tagged with this org_id are
                returned. ``None`` returns all nodes/edges.
        ...
        return await self.chunk_entity_relation_graph.get_knowledge_graph(
            node_label, max_depth, max_nodes, org_id=org_id
        )
    ...
    async def ainsert(
        ...
        # snapshot before enqueue so they become a per-document setting.
