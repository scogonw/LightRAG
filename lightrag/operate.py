...
async def extract_entities(
    ...
    async def _process_single_content(chunk_key_dp: tuple[str, TextChunkSchema]):
        ...
        # Strip parser-internal markup before extraction; stored chunk is unchanged.
...
async def _get_node_data(
    ...
    nodes_dict, degrees_dict = await asyncio.gather(
        knowledge_graph_inst.get_nodes_batch(node_ids, metadata_filter=query_param.metadata_filter, org_id=query_param.org_id),
        knowledge_graph_inst.node_degrees_batch(node_ids, metadata_filter=query_param.metadata_filter, org_id=query_param.org_id),
    )
...
async def _find_most_related_edges_from_entities(
    ...
    edge_data_dict, edge_degrees_dict = await asyncio.gather(
        knowledge_graph_inst.get_edges_batch(edge_pairs_dicts, metadata_filter=query_param.metadata_filter, org_id=query_param.org_id),
        knowledge_graph_inst.edge_degrees_batch(edge_pairs_tuples, metadata_filter=query_param.metadata_filter, org_id=query_param.org_id),
    )
...
async def _get_edge_data(
    ...
    edge_data_dict = await knowledge_graph_inst.get_edges_batch(edge_pairs_dicts, metadata_filter=query_param.metadata_filter, org_id=query_param.org_id)
